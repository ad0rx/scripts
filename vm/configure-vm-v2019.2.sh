...
PETALINUX=/media/sf_downloads/petalinux/petalinux-v${XILINX_VERSION}-final-installer.run
PETALINUX_DIR=/app/petalinux/${XILINX_VERSION}

SSH_ID=/media/sf_support/ssh-key-virtualbox/*
...
cd $PETALINUX_DIR/components/yocto/source/aarch64/layers/core/scripts/postinst-intercepts
mkdir hold
mv update_font_cache          hold
mv update_gio_module_cache    hold
mv update_gtk_immodules_cache hold
mv update_icon_cache          hold
mv update_pixbuf_cache        hold
